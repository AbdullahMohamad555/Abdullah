...
public class MoreFragment extends Fragment {
    ...
    private String[] textList = {"من نحن", "وسائل التبرع", "إتصل بنا", "الأخبار", "خيرك دايم", "أنشطة تنوعية"};
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        MyListAdapter adapter = new MyListAdapter(getContext(), R.layout.custom_list, textList, iconsList);
